        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(txt_username) && TextUtils.isEmpty(txt_password)) {
                    Toast.makeText(LogIn.this, "Every Field is required", Toast.LENGTH_SHORT).show();
                } else {
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (!task.isSuccessful()) {
                                                        ...
                                                        Toast.makeText(LogIn.this, "Password reset mail has been sent to you.", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                                }
